...
// 布局插件
				...
				workorderAttributeDeviceInformationUserInformationChangeTabArr: [1,2,3,4,5,6,7,8,9,0,11,12,13,14,15,16,17],
				input3Tab:'AIHELPAIHELP',
				// 分配工单下拉框
				statusOptions:[{
					value: '1',
					label: '未分配'
