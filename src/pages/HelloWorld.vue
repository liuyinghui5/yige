...
<template>
  ...
  <div class="helloWorld" v-show="true">
    ...
    <div style="border: 1px solid;display: inline-block;width: 50px;margin-left: 50px;transform: skew(20deg, 0deg);">
      DIV画平行四边形
    </div>
    <div
        style="width: 0;height: 0;display: inline-block;border-top: 100px solid transparent;border-bottom: 100px solid green;border-left: 100px solid transparent;border-right: 100px solid transparent;">
      DIV画三角形
    </div>
...
//			var arr1 =[{content: "六六六", fastWord: "1"},{content: "七七七", fastWord: "2,3"},{content: "刘刘刘", fastWord: "1,2,3"}];
//
//			var sa = arr1.reduce((prev,curr)=>{
//				let b = [];
//				b.push(...prev,curr.fastWord.split(',').map(items=>({content:curr.content,fastWord:items})))
//				return b
//			},[])
//
...
//			.workorder-all .tabDetail .tabDetail-item-in .el-input__inner
    ...
    //   }
    // }
    // console.log('打印的temp ->', arr5)

    // arr5.sort((a,b)=>{
    //   return a.age -b.age
    // })
    // arr5.sort((a,b)=>{return a.age-b.age})
    // console.log('打印的arr5 ->', arr5)

    // let re = arr5.reduce((prev,{age})=> {
    //   let b = []
    //   b.push(...prev,age)
    //   console.log('打印的b ->', b)
    //   return b
